...
Another reason a loan might not be disbursed is if a loan-seeker did not meet the requirements under the PPP program, which changed throughout the life of the program and are more complex (and therefore easier to misinterpret). Consudering this document:
