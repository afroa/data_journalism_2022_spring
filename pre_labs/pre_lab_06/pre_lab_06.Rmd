...
```{r}
voters_by_county <- read_csv("clean_tabula-Eligible Active Voters by County - PG20.csv")
...
**Task** Run the following code to load and clean up the data — turns "net_dollars" into <num>
