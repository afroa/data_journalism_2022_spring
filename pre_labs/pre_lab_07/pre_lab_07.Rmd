...
**I see an overview of Industry Classifications, including a table of NAICS sectors described in a top-level way (with two-digit NAICS codes).**
...
**Answer**
It looks like the head of an HTML document, including the meta tags and the top couple of lines of the code.
...
**Answer**
I see a list of 2, with  three rows under naics_industry.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
It's an image of the HTML data frame.
### Task 9: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
```{r, echo=FALSE}
...
**It's a list of 6 dataframes that contain all of the tables in the original HTML code.**
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**It adds a lot of data to the naics_industry variable, for a total of 6 tibbles contained within the dataframe.**
...
**It's a single row, with what looks to be the different NAICS identifying codes (but only the two-digit versions).**
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**It's a single row, with what looks to be the different NAICS industries**
...
**It's thew specific table of two-digit NAICS code and their respective industries.**
...
**Answer**
We've got our friendly NAICS table with industry and two-digit codes
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**It's the BLS workforce statistics page**
...
The table shows that for the mining sector, it was 538.6  -- or 538,600 -- in November 2021.  That's the value we want to ingest in R. 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
This is the top of the HTML doc, including the meta tags
```{r}
...
**This loads the table element from the URL and splits it into different tibbles for each grouping of the element**
...
**This created a table which includes employment and unemployment data figures from Nov. 2021 to Feb. 2022**
...
**A small table with a single row of the seasonally-adjusted employment number for Nov. 2021, all employees.**
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**These are the workforce stats for Mining, Quarrying, and Oil and Gas Extraction (NAICS 21)**
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**These are the workforce stats for Construction (NAICS 23)**
...
**This is a simple list of the sectors printed in individual rows.**
```{r}
...
**This seems to split the sectors into two different columns.**
```{r}
...
**Answer**
This prints out a list of the NAICS industries
...
**Answer**
This is a row-by-row printout of row numbers from 1-10
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer**
This is a table of NAICS industries and their respective two-digit codes
```{r}
...
**Answer**
This is a sequence of numbers, ascending, in individual rows
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
...
**Answer**
This shows that there were 536.9 employees in Nov. 2021 (seasonally-adjusted)
```{r}
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
This loaded the NAICS data from the last chapter
```{r}
# Define url of page we want to scrape
...
**Answer**
This attaches the URLs to the NAICs industries
```{r}
...
**Answer**
It's a table with NAICS codes, respective sector URLs and xpaths
...
**Answer**
It's the NAICS industry and respective URL (and sector path) in individual tibbles
```{r}
...
**Answer**
It's a list with all of the URLs
```{r}
...
**Answer**
This is all the employment info, separated into tibbles!
...
**Answer**
I think it's tibbles for each NAICS industry from Nov. to Feb., but it doesn't show the actul codes.
...
**Answer**
It's a bunch of tibbles, each is a NAICS industry and the number of employees, seasonall-adjusted, from Nov. 2021 to Feb. 2022
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
It's a bunch of tibbles, each is a NAICS industry and the number of employees in Nov. 2021.
```{r}
...
**Answer**
This is a table of NAICS industries (sorted by two-digit NAICS codes) and the number of employees in Nov. 2021.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
It's the BLS page for Mining, Quarrying, and Oil and Gas Extraction: NAICS 21
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
It's the BLS page for Agriculture, Forestry, Fishing and Hunting: NAICS 11.
...
**Answer**
It's the table, but it keeps NA in the Agriculture row.
