...
What is the payroll proceeds percentage for the first result? Put your answer in the space below.
**Answer**
It is 0%, for CHESAPEAKE CREWING, L.L.C.
...
mutate(
  jobs_retained_category = case_when(
    ...
    #AR: I added the row below to make sure it matches up to what we did in class
...
**Answer**
After filtering with those parameters, only 146 of the 190k loan applications meet that criteria
...
What is the number of applications that meet that criteria? Put your answer in the space below.
**Answer**
52724 loan applications meet those parameters
...
```{r}
# using read.csv <- this is "base R," before the tidyverse. It makes few assumptions, tries to be conservative regarding what it thinks things are
...
**Answer**
It looks like the datatype is "<chr>"
...
**Answer**
'date_approved' is still <chr>, but 'CleanDate' is <dttm>
...
**Answer**
April, 2020 saw the most applications with 45042
