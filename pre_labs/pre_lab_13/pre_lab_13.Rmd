...
**Answer**
A fairly strong left-to-right increase in slope
```{r}
...
**Task** Run the following code. Describe the plot. What do you see?
**Answer**
This is a less pronounced slope with a wider range of scattering data
```{r}
...
**Answer**
Percentage of businesses receiveing PPP are more strongly correlated to pct_Trump vote than the PPP amount per employee
```{r}
reveal_data %>%
...
**Answer**
This seems like a printed version of the above, that shows a .52 correlation between businesses receiving PPP and pct_trump
```{r}
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer**
Like above, this reflects the smaller correlation between PPP amounts for employees and pct_trump
```{r}
...
**Answer**
A three column table detailing the mean PPP amount per employee, and the difference between Clinton/Trump states.
```{r}
reveal_data %>%
  group_by(vote_2016) %>%
  summarise(
...
**Answer**
Both means, a t-value and a p-value that show a bit of a difference in Trump v. Clinton states.
```{r}
...
**Task** Run the following code. Describe the output. What do you see?
**Answer**
Both means, a t-value and a p-value that show a greater difference in Trump v. Clinton states.
```{r}
