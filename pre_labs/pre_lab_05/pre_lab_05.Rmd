...
**Answer**
Some cities are, well...not. Like ABDULREZAK H ISSAC. There are also instances of creative spellings like with Abereen or the olde favorite, Anold. 
```{r}
...
**Answer**
It changed "PHOENIX" and "WESTMINSTER" to title case ("Phoenix," and "Westminster.") However, it kept EASTON in full-caps.
```{r}
...
**Answer**
This effectively shifted what it could to title case. ABELL to Abell, ABERDEEN to Aberdeen, ANDREWS AIR FORCE BASE to ANDREWS AIR FORCE BASE. It didn't work fully.
...
**Answer**
Not really. It looks to have done the same title case job.
